...
<div class="cover">
  ...
  <div class="verdict">
    <b>Verdict:</b> SLD v3 is <b>not release-ready</b> — a non-functional Export, a create flow that
    can only produce orphan (unconnected) nodes, the S1/S2/S6 data-integrity cluster (87 of 107 SLDs),
    and a 2&times; render cost are all open. Security &amp; stored-XSS, however, tested <b>clean</b>.
  </div>
</div>
"""))
